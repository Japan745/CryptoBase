...
def get_doge_info():
    ...
    st.header("Dogecoin White Paper")

    with open("Dogecoin Cash Whitepaper.pdf", "rb") as file:
        btn = st.download_button(
            label="Click me! to download white paper",
            data=file,
            file_name="Dogecoin Cash Whitepaper.pdf",
    ...
    with st.expander(" 👁  Dogecoin white paper "):
        st_display_pdf("Dogecoin Cash Whitepaper.pdf")